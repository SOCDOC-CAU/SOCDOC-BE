...
public class ReviewController {
    ...
    public ApiResponse<List<ResponseReviewDto>> readReviewByUserId(@PathVariable String userId) {
    ...
    public ApiResponse<List<ResponseReviewDto>> readReviewByHospitalId(@PathVariable String hospitalId) {
        return ApiResponse.success(reviewService.readReviewByHospitalId(hospitalId), ResponseCode.REVIEW_READ_SUCCESS.getMessage());
    }

    @PostMapping("/create")
    public ApiResponse<String> createReview(CreateReviewDto createReviewDto) {
        return ApiResponse.success(reviewService.createReview(createReviewDto), ResponseCode.REVIEW_CREATE_SUCCESS.getMessage());
    }

    @PutMapping("/update")
    public ApiResponse<Void> updateReview(UpdateReviewDto updateReviewDto) {
