...
public interface HospitalRepository {
    ...
    List<Hospital> findHospitalByMain(String address1, String address2, String code1, String code2, String code3, String code4) throws ExecutionException, InterruptedException;
}
